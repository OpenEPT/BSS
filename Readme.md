...
To configure displayed algorithm results, open the Simulation Display Settings window using the button shown in Figure 6.

![Simulation Display Settings Button](images/SimulationDisplaySettingsButton.png)

**Figure 6.** Simulation display settings button.

The corresponding configuration window is shown in Figure 7.

![Simulation Display Settings](images/SimulationDisplaySettings.png)

**Figure 7.** Simulation display settings window.
...
![Simulation Log Button](images/SimulatorLogButton.png)

**Figure 8.** Simulation log button.

![Simulation Log](images/SimulatorLog.png)

**Figure 9.** Simulation log window.
